...
class cpselect_recorder:
	...
	def __call__(self, event):
		...
		# self.left_x.append(0)
		# self.left_y.append(0)
		# self.right_x.append(0)
		# self.right_y.append(0)
		# self.left_x.append(500)
		# self.left_y.append(500)
		# self.right_x.append(500)
		# self.right_y.append(500)
		# self.left_x.append(0)
		# self.left_y.append(500)
		# self.right_x.append(0)
		# self.right_y.append(500)
		...
		if event.inaxes == self.Ax0:
			...
			#self.left_x.append((0, 0))
			self.left_y.append(event.ydata)
			#self.left_y.append((0, 0))
			self.Ax0.add_artist(circle)
			plt.show()
...
def cpselect(img1,img2):
	...
	#points_left = np.concatenate([[0,0], [300,300], [0,300], [300,0]], axis = 1)
	#points_right = np.concatenate([[0,0], [300,300], [0,300], [300,0]], axis = 1)
